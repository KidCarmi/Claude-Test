...
// dns_resolve_chaos_test.go — CHAOS-60 gates.
//
...
// TestChaos60_WedgedResolverDoesNotBlockTheRequestPathForever pins the
...
func TestChaos60_WedgedResolverDoesNotBlockTheRequestPathForever(t *testing.T) {
...
// TestChaos60_TimeoutIsCountedAndClassified: a deadline overrun must be
// visible. Pre-fix nothing on this path counted, logged or alerted a failure.
func TestChaos60_TimeoutIsCountedAndClassified(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos60_ConcurrentMissesForOneHostResolveOnce pins the single-flight.
//
...
// failing.
func TestChaos60_ConcurrentMissesForOneHostResolveOnce(t *testing.T) {
	release := make(chan struct{})
...
// TestChaos60_FollowersAreReleasedWhenTheLeaderSheds: a leader that sheds must
...
func TestChaos60_FollowersAreReleasedWhenTheLeaderSheds(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos60_ResolverOutageDoesNotTakeGeoRulesDark is the security half.
//
...
// every host at once.
func TestChaos60_ResolverOutageDoesNotTakeGeoRulesDark(t *testing.T) {
...
// TestChaos60_FailedRefreshDoesNotDestroyTheStaleAnswer proves the background
...
func TestChaos60_FailedRefreshDoesNotDestroyTheStaleAnswer(t *testing.T) {
...
// TestChaos60_StaleServesDoNotStackRefreshes pins at most ONE refresh per host,
...
func TestChaos60_StaleServesDoNotStackRefreshes(t *testing.T) {
...
// TestChaos60_ExpiredNegativeEntryIsNotStaleServed pins that stale serving is
...
func TestChaos60_ExpiredNegativeEntryIsNotStaleServed(t *testing.T) {
...
// TestChaos60_ExpiredNegativeStillReResolvesWhenTheResolverPoolIsSaturated is
// the load half of the same finding: the repair must not depend on the async
// refresh, which sheds when the pool is full.
func TestChaos60_ExpiredNegativeStillReResolvesWhenTheResolverPoolIsSaturated(t *testing.T) {
...
// TestChaos60_DistinctHostFloodIsShedNotQueued proves a herd spread across many
...
func TestChaos60_DistinctHostFloodIsShedNotQueued(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos60_ShedResultIsNotCached: saturation is a fact about THIS node's
...
func TestChaos60_ShedResultIsNotCached(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
	restore := shrinkResolverPool(t, 0)
...
// TestChaos60_NXDOMAINNeverDrivesDegradation keeps an authoritative "no such
...
// the page on demand.
func TestChaos60_NXDOMAINNeverDrivesDegradation(t *testing.T) {
	resetDNSResolveHealthForTest()
...
// TestChaos60_DegradationIsADurationAndAlertsOnce pins the threshold as a
// DURATION and the page as fire-once per episode.
func TestChaos60_DegradationIsADurationAndAlertsOnce(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos60_RecoveryIsOnObservedEvidence requires an observed successful
...
func TestChaos60_RecoveryIsOnObservedEvidence(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos60_PrivateOnlyAnswerIsNotAResolverFault treats an answer carrying only
...
func TestChaos60_PrivateOnlyAnswerIsNotAResolverFault(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos60_AlertDetailIsBounded pins the dedup-key contract on BOTH
...
// alerts (WK-12/RS-5).
func TestChaos60_AlertDetailIsBounded(t *testing.T) {
...
func TestChaos60_ClassifyDNSFailureClasses(t *testing.T) {
	cases := []struct {
		name string
		err  error
		want string
...
// TestChaos60_NXDOMAINAtTheDeadlineBoundaryStaysNXDOMAIN keeps an authoritative
...
func TestChaos60_NXDOMAINAtTheDeadlineBoundaryStaysNXDOMAIN(t *testing.T) {
...
// TestChaos60_ContractRowReportsWarnNotFail pins the degraded contract row at
...
// serving.
func TestChaos60_ContractRowReportsWarnNotFail(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos60_ContractRowNeverCarriesAHostname: /api/diagnostics is a
...
func TestChaos60_ContractRowNeverCarriesAHostname(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
func TestChaos60_Control_HealthyResolutionStillWorks(t *testing.T) {
...
func TestChaos60_Control_UnresolvableHostStillFailsAndIsCounted(t *testing.T) {
...
// TestChaos60_StaleServeIsCounted: the stale-served counter is the leading
...
func TestChaos60_StaleServeIsCounted(t *testing.T) {
