...
// dns_resolve_chaos_test.go — CHAOS-61 gates.
//
...
// TestChaos61_WedgedResolverDoesNotBlockTheRequestPathForever pins the
...
func TestChaos61_WedgedResolverDoesNotBlockTheRequestPathForever(t *testing.T) {
...
// TestChaos61_TimeoutIsCountedAndClassified: a deadline overrun must be
// visible. Pre-fix nothing on this path counted, logged or alerted a failure.
func TestChaos61_TimeoutIsCountedAndClassified(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos61_ConcurrentMissesForOneHostResolveOnce pins the single-flight.
//
...
// failing.
func TestChaos61_ConcurrentMissesForOneHostResolveOnce(t *testing.T) {
	release := make(chan struct{})
...
// TestChaos61_FollowersAreReleasedWhenTheLeaderSheds: a leader that sheds must
...
func TestChaos61_FollowersAreReleasedWhenTheLeaderSheds(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos61_ResolverOutageDoesNotTakeGeoRulesDark is the security half.
//
...
// every host at once.
func TestChaos61_ResolverOutageDoesNotTakeGeoRulesDark(t *testing.T) {
...
// TestChaos61_FailedRefreshDoesNotDestroyTheStaleAnswer proves the background
...
func TestChaos61_FailedRefreshDoesNotDestroyTheStaleAnswer(t *testing.T) {
...
// TestChaos61_StaleServesDoNotStackRefreshes pins at most ONE refresh per host,
...
func TestChaos61_StaleServesDoNotStackRefreshes(t *testing.T) {
...
// TestChaos61_ExpiredNegativeEntryIsNotStaleServed pins that stale serving is
...
func TestChaos61_ExpiredNegativeEntryIsNotStaleServed(t *testing.T) {
...
// TestChaos61_ExpiredNegativeStillReResolvesWhenTheResolverPoolIsSaturated is
// the load half of the same finding: the repair must not depend on the async
// refresh, which sheds when the pool is full.
func TestChaos61_ExpiredNegativeStillReResolvesWhenTheResolverPoolIsSaturated(t *testing.T) {
...
// TestChaos61_DistinctHostFloodIsShedNotQueued proves a herd spread across many
...
func TestChaos61_DistinctHostFloodIsShedNotQueued(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos61_ShedResultIsNotCached: saturation is a fact about THIS node's
...
func TestChaos61_ShedResultIsNotCached(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
	restore := shrinkResolverPool(t, 0)
...
// TestChaos61_NXDOMAINNeverDrivesDegradation keeps an authoritative "no such
...
// the page on demand.
func TestChaos61_NXDOMAINNeverDrivesDegradation(t *testing.T) {
	resetDNSResolveHealthForTest()
...
// TestChaos61_DegradationIsADurationAndAlertsOnce pins the threshold as a
// DURATION and the page as fire-once per episode.
func TestChaos61_DegradationIsADurationAndAlertsOnce(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos61_RecoveryIsOnObservedEvidence requires an observed successful
...
func TestChaos61_RecoveryIsOnObservedEvidence(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos61_PrivateOnlyAnswerIsNotAResolverFault treats an answer carrying only
...
func TestChaos61_PrivateOnlyAnswerIsNotAResolverFault(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos61_AlertDetailIsBounded pins the dedup-key contract on BOTH
...
// alerts (WK-12/RS-5).
func TestChaos61_AlertDetailIsBounded(t *testing.T) {
...
func TestChaos61_ClassifyDNSFailureClasses(t *testing.T) {
	cases := []struct {
		name string
		err  error
		want string
...
// TestChaos61_NXDOMAINAtTheDeadlineBoundaryStaysNXDOMAIN keeps an authoritative
...
func TestChaos61_NXDOMAINAtTheDeadlineBoundaryStaysNXDOMAIN(t *testing.T) {
...
// TestChaos61_ContractRowReportsWarnNotFail pins the degraded contract row at
...
// serving.
func TestChaos61_ContractRowReportsWarnNotFail(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos61_ContractRowNeverCarriesAHostname: /api/diagnostics is a
...
func TestChaos61_ContractRowNeverCarriesAHostname(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
func TestChaos61_Control_HealthyResolutionStillWorks(t *testing.T) {
...
func TestChaos61_Control_UnresolvableHostStillFailsAndIsCounted(t *testing.T) {
...
// TestChaos61_StaleServeIsCounted: the stale-served counter is the leading
...
func TestChaos61_StaleServeIsCounted(t *testing.T) {
