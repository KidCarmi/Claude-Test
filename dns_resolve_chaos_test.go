...
// dns_resolve_chaos_test.go — CHAOS-64 gates.
//
...
// TestChaos64_WedgedResolverDoesNotBlockTheRequestPathForever pins the
...
func TestChaos64_WedgedResolverDoesNotBlockTheRequestPathForever(t *testing.T) {
...
// TestChaos64_TimeoutIsCountedAndClassified: a deadline overrun must be
// visible. Pre-fix nothing on this path counted, logged or alerted a failure.
func TestChaos64_TimeoutIsCountedAndClassified(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos64_ConcurrentMissesForOneHostResolveOnce pins the single-flight.
//
...
// failing.
func TestChaos64_ConcurrentMissesForOneHostResolveOnce(t *testing.T) {
	release := make(chan struct{})
...
// TestChaos64_FollowersAreReleasedWhenTheLeaderSheds: a leader that sheds must
...
func TestChaos64_FollowersAreReleasedWhenTheLeaderSheds(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos64_ResolverOutageDoesNotTakeGeoRulesDark is the security half.
//
...
// every host at once.
func TestChaos64_ResolverOutageDoesNotTakeGeoRulesDark(t *testing.T) {
...
// TestChaos64_FailedRefreshDoesNotDestroyTheStaleAnswer proves the background
...
func TestChaos64_FailedRefreshDoesNotDestroyTheStaleAnswer(t *testing.T) {
...
// TestChaos64_StaleServesDoNotStackRefreshes pins at most ONE refresh per host,
...
func TestChaos64_StaleServesDoNotStackRefreshes(t *testing.T) {
...
// TestChaos64_ExpiredNegativeEntryIsNotStaleServed pins that stale serving is
...
func TestChaos64_ExpiredNegativeEntryIsNotStaleServed(t *testing.T) {
...
// TestChaos64_ExpiredNegativeStillReResolvesWhenTheResolverPoolIsSaturated is
// the load half of the same finding: the repair must not depend on the async
// refresh, which sheds when the pool is full.
func TestChaos64_ExpiredNegativeStillReResolvesWhenTheResolverPoolIsSaturated(t *testing.T) {
...
// TestChaos64_DistinctHostFloodIsShedNotQueued proves a herd spread across many
...
func TestChaos64_DistinctHostFloodIsShedNotQueued(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
...
// TestChaos64_ShedResultIsNotCached: saturation is a fact about THIS node's
...
func TestChaos64_ShedResultIsNotCached(t *testing.T) {
	release := make(chan struct{})
	defer close(release)
	blockingResolver(t, release, nil, nil)
	restore := shrinkResolverPool(t, 0)
...
// TestChaos64_NXDOMAINNeverDrivesDegradation keeps an authoritative "no such
...
// the page on demand.
func TestChaos64_NXDOMAINNeverDrivesDegradation(t *testing.T) {
	resetDNSResolveHealthForTest()
...
// TestChaos64_DegradationIsADurationAndAlertsOnce pins the threshold as a
// DURATION and the page as fire-once per episode.
func TestChaos64_DegradationIsADurationAndAlertsOnce(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos64_RecoveryIsOnObservedEvidence requires an observed successful
...
func TestChaos64_RecoveryIsOnObservedEvidence(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos64_PrivateOnlyAnswerIsNotAResolverFault treats an answer carrying only
...
func TestChaos64_PrivateOnlyAnswerIsNotAResolverFault(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos64_AlertDetailIsBounded pins the dedup-key contract on BOTH
...
// alerts (WK-12/RS-5).
func TestChaos64_AlertDetailIsBounded(t *testing.T) {
...
func TestChaos64_ClassifyDNSFailureClasses(t *testing.T) {
	cases := []struct {
		name string
		err  error
		want string
...
// TestChaos64_NXDOMAINAtTheDeadlineBoundaryStaysNXDOMAIN keeps an authoritative
...
func TestChaos64_NXDOMAINAtTheDeadlineBoundaryStaysNXDOMAIN(t *testing.T) {
...
// TestChaos64_ContractRowReportsWarnNotFail pins the degraded contract row at
...
// serving.
func TestChaos64_ContractRowReportsWarnNotFail(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
// TestChaos64_ContractRowNeverCarriesAHostname: /api/diagnostics is a
...
func TestChaos64_ContractRowNeverCarriesAHostname(t *testing.T) {
	resetDNSResolveHealthForTest()
	defer resetDNSResolveHealthForTest()
...
func TestChaos64_Control_HealthyResolutionStillWorks(t *testing.T) {
...
func TestChaos64_Control_UnresolvableHostStillFailsAndIsCounted(t *testing.T) {
...
// TestChaos64_StaleServeIsCounted: the stale-served counter is the leading
...
func TestChaos64_StaleServeIsCounted(t *testing.T) {
