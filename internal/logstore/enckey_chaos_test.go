...
// enckey_chaos_test.go — CHAOS-61 gates for the salt sidecar.
//
...
// history.
func TestChaos61_TornSaltNeverMintsOverAnExistingStore(t *testing.T) {
...
// material.
func TestChaos61_MissingSaltNeverMintsOverAnExistingStore(t *testing.T) {
...
func TestChaos61_SaltIsMintedWhenThereIsNothingToLose(t *testing.T) {
...
func TestChaos61_UnreadableStoreDirectoryRefusesRatherThanMinting(t *testing.T) {
	if os.Geteuid() == 0 {
