...
// enckey_chaos_test.go — CHAOS-62 gates for the salt sidecar.
//
...
// history.
func TestChaos62_TornSaltNeverMintsOverAnExistingStore(t *testing.T) {
...
// material.
func TestChaos62_MissingSaltNeverMintsOverAnExistingStore(t *testing.T) {
...
func TestChaos62_SaltIsMintedWhenThereIsNothingToLose(t *testing.T) {
...
func TestChaos62_UnreadableStoreDirectoryRefusesRatherThanMinting(t *testing.T) {
	if os.Geteuid() == 0 {
