...
// resilient_chaos_test.go — CHAOS-62 gates for OpenResilientTTL.
//
...
func TestChaos62_SurvivesUncatchableOpenPanicOnNextRun(t *testing.T) {
...
// claims.
func TestChaos62_BareOpenTTLPanicIsUncatchableAtTheCallSite(t *testing.T) {
	...
	out, err := runChild(t, "TestChaos62_BareOpenTTLPanicIsUncatchableAtTheCallSite", "CULVERT_LOGSTORE_BAREOPEN_CHILD", dir)
	if err == nil {
...
func runHistoryChild(t *testing.T, dir string) (string, error) {
	t.Helper()
	return runChild(t, "TestChaos62_SurvivesUncatchableOpenPanicOnNextRun", "CULVERT_LOGSTORE_PANIC_CHILD", dir)
}
...
func TestChaos62_TornManifestIsQuarantinedAndReopened(t *testing.T) {
...
func TestChaos62_QuarantinedHistoryStaysReadableWithTheSameSalt(t *testing.T) {
	dir := seedHistory(t, 50)
...
func TestChaos62_ChangedPassphraseIsNeverQuarantined(t *testing.T) {
	dir := seedHistory(t, 50)
...
func TestChaos62_ScrambledKeyRegistryDegradesRatherThanQuarantining(t *testing.T) {
	dir := seedHistory(t, 50)
...
func TestChaos62_BothPolicyLayersExemptEncryptionErrors(t *testing.T) {
...
// owner.
func TestChaos62_LiveOwnerIsNeverQuarantined(t *testing.T) {
...
func TestChaos62_HealthyStoreIsUntouched(t *testing.T) {
	dir := seedHistory(t, 20)
	s, rec, err := openHistory(t, dir)
	if err != nil {
		t.Fatalf("open: %v", err)
