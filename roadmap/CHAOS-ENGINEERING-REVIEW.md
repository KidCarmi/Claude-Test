...
### 28.4 The alert-plane defect found alongside
...
### 28.5a Review finding — stale serving is for POSITIVE entries only
...
### 28.6 Residual risk (owner decisions, recorded not fixed)
