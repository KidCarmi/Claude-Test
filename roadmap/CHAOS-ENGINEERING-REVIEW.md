...
## 25. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 25.3 Why "it exits, so it fails closed" is wrong
...
### 25.4 The codebase already knew
...
### 25.8 The lesson this sweep adds
