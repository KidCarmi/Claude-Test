...
## 26. CHAOS-58 — The intelligence-feed plane under origin outage
...
### 26.1 The finding in one sentence
...
### 26.2 Why it was invisible, and why that is this sweep's fault
...
### 26.3 The cadence defect (WK-5, WK-6)
...
### 26.4 The severe shape: a cold start into an outage (WK-5c)
...
### 26.5 The fleet shape: a self-inflicted herd (WK-13b)
...
### 26.7 Rejected alternatives, recorded
