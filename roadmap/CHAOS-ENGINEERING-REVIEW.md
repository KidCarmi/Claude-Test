...
it now?*
## 28. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 28.3 Why "it exits, so it fails closed" is wrong
...
### 28.4 The codebase already knew
...
### 28.8 The lesson this sweep adds
