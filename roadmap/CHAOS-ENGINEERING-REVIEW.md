...
## 32. CHAOS-63 — Destination-host DNS resolution on the policy path
...
### 32.4 The alert-plane defect found alongside
...
### 32.5a Review finding — stale serving is for POSITIVE entries only
...
### 32.6 Residual risk (owner decisions, recorded not fixed)
...
### 32.7 GEO-1 — a latent process-kill armed by a comment (recorded, not fixed)
