...
### 29.4 The alert-plane defect found alongside
...
### 29.5a Review finding — stale serving is for POSITIVE entries only
...
### 29.6 Residual risk (owner decisions, recorded not fixed)
