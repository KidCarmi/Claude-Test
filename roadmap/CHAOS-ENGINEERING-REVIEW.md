...
## 27. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 27.3 Why "it exits, so it fails closed" is wrong
...
### 27.4 The codebase already knew
...
### 27.8 The lesson this sweep adds
