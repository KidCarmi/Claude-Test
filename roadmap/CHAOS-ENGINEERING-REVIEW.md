...
## 31. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 31.3 Why "it exits, so it fails closed" is wrong
...
### 31.4 The codebase already knew
...
### 31.8 The lesson this sweep adds
