...
## 25. CHAOS-57 — The Data Plane's outbound cluster state under a Control Plane outage
...
### 25.2 CL-20 — a rate-limit broadcast that never expired
...
### 25.3 CL-21 — the DP→CP audit push queue dropped silently
