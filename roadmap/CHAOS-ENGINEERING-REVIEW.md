...
## 26. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 26.3 Why "it exits, so it fails closed" is wrong
...
### 26.4 The codebase already knew
...
### 26.8 The lesson this sweep adds
