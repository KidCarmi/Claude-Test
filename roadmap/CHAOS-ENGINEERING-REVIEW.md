...
## 26. CHAOS-57 — The request-history store under a damaged data volume
...
### 26.2 The panic, re-measured for THIS store
...
### 26.3 What made this worse than the category store
...
### 26.4 The deferral's own reasoning, inverted
...
### 26.5 LS-4 — the read path destroyed the key
...
### 26.6b Review follow-up — a defect in the mechanism itself (LS-5)
