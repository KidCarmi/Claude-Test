...
## 26. CHAOS-57 — The Data Plane's outbound cluster state under a Control Plane outage
...
### 26.2 CL-20 — a rate-limit broadcast that never expired
...
### 26.3 CL-21 — the DP→CP audit push queue dropped silently
...
### 26.4b Review follow-up — a defect in the fix itself (Codex, PR #1346)
