...
## 32. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 32.3 Why "it exits, so it fails closed" is wrong
...
### 32.4 The codebase already knew
...
### 32.8 The lesson this sweep adds
