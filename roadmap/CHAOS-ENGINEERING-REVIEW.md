...
## 27. CHAOS-57 — The Data Plane's outbound cluster state under a Control Plane outage
...
### 27.2 CL-20 — a rate-limit broadcast that never expired
...
### 27.3 CL-21 — the DP→CP audit push queue dropped silently
...
### 27.4b Review follow-up — a defect in the fix itself (Codex, PR #1346)
