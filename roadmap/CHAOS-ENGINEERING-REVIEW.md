...
## 30. CHAOS-61 — Destination-host DNS resolution on the policy path
...
### 30.4 The alert-plane defect found alongside
...
### 30.5a Review finding — stale serving is for POSITIVE entries only
...
### 30.6 Residual risk (owner decisions, recorded not fixed)
...
### 30.7 GEO-1 — a latent process-kill armed by a comment (recorded, not fixed)
