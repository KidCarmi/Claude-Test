...
it now?*
## 28. CHAOS-57 — Credential verification as an unbounded, unauthenticated CPU sink
...
### 28.3 Two amplifiers found alongside it
...
### 28.4 The finding inside the fix
...
### 28.4b The second finding inside the fix — an authentication BYPASS
...
### 28.4c The third finding inside the fix — the governor denying service itself
...
### 28.4d The fourth finding inside the fix — the alert that could never fire
...
### 28.7 What is deliberately left
...
### 28.7b The cost that is actually paid: restart and mass reconnect
