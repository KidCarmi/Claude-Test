...
### 31.4 The alert-plane defect found alongside
...
### 31.5a Review finding — stale serving is for POSITIVE entries only
...
### 31.6 Residual risk (owner decisions, recorded not fixed)
