...
## 30. CHAOS-57 — The admin UI listener, and which plane is allowed to kill which
...
### 30.3 Why "it exits, so it fails closed" is wrong
...
### 30.4 The codebase already knew
...
### 30.8 The lesson this sweep adds
