...
// logstore_chaos_test.go — CHAOS-60 gates for the composition root's half of
...
func TestChaos60_EnableRecoversDamagedStoreAndSurfacesIt(t *testing.T) {
...
func TestChaos60_UnopenableStoreDegradesAndStaysVisible(t *testing.T) {
	dir := withHistoryStore(t)
	seedRootHistory(t, dir)
...
func TestChaos60_LostSaltIsReportedWithItsOwnRemedy(t *testing.T) {
	dir := withHistoryStore(t)
	seedRootHistory(t, dir)
...
func TestChaos60_HealthyEnableReportsNothing(t *testing.T) {
	dir := withHistoryStore(t)
...
func TestChaos60_DisabledIsOKButUnreconciledEvidenceStillWarns(t *testing.T) {
	dir := withHistoryStore(t)
