...
// logstore_chaos_test.go — CHAOS-61 gates for the composition root's half of
...
func TestChaos61_EnableRecoversDamagedStoreAndSurfacesIt(t *testing.T) {
...
func TestChaos61_UnopenableStoreDegradesAndStaysVisible(t *testing.T) {
	dir := withHistoryStore(t)
	seedRootHistory(t, dir)
...
func TestChaos61_LostSaltIsReportedWithItsOwnRemedy(t *testing.T) {
	dir := withHistoryStore(t)
	seedRootHistory(t, dir)
...
func TestChaos61_HealthyEnableReportsNothing(t *testing.T) {
	dir := withHistoryStore(t)
...
func TestChaos61_DisabledIsOKButUnreconciledEvidenceStillWarns(t *testing.T) {
	dir := withHistoryStore(t)
