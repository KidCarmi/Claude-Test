...
// logstore_chaos_test.go — CHAOS-62 gates for the composition root's half of
...
func TestChaos62_EnableRecoversDamagedStoreAndSurfacesIt(t *testing.T) {
...
func TestChaos62_UnopenableStoreDegradesAndStaysVisible(t *testing.T) {
	dir := withHistoryStore(t)
	seedRootHistory(t, dir)
...
func TestChaos62_LostSaltIsReportedWithItsOwnRemedy(t *testing.T) {
	dir := withHistoryStore(t)
	seedRootHistory(t, dir)
...
func TestChaos62_HealthyEnableReportsNothing(t *testing.T) {
	dir := withHistoryStore(t)
...
func TestChaos62_DisabledIsOKButUnreconciledEvidenceStillWarns(t *testing.T) {
	dir := withHistoryStore(t)
