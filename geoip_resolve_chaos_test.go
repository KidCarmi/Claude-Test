...
// CHAOS-57 — the GeoIP resolution chain under a slow / unavailable resolver.
//
...
// TestChaos57_LookupCachedNeverBlocksOnDNS is the primary defect gate. The
...
func TestChaos57_LookupCachedNeverBlocksOnDNS(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_PreFixShapeBlocksOnDNS is a permanent DEFECT PROOF. It rebuilds
...
func TestChaos57_PreFixShapeBlocksOnDNS(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_ConcurrentMissesResolveOnce pins the single-flight. Pre-fix,
...
func TestChaos57_ConcurrentMissesResolveOnce(t *testing.T) {
...
// TestChaos57_WarmConvergesWithoutTheDashboardSampler is the GEO-2 gate. The
...
func TestChaos57_WarmConvergesWithoutTheDashboardSampler(t *testing.T) {
...
// TestChaos57_WarmFiresWhenOnlyTheCountryHalfIsMissing covers the other miss
...
func TestChaos57_WarmFiresWhenOnlyTheCountryHalfIsMissing(t *testing.T) {
	eng := newGeoTestEngine(t)
...
// TestChaos57_NegativeCachedHostDoesNotWarm pins the other direction: a host
...
func TestChaos57_NegativeCachedHostDoesNotWarm(t *testing.T) {
	eng := newGeoTestEngine(t)
...
// TestChaos57_WarmIsBoundedAndDropsWhenSaturated pins the drop-on-full bound.
...
func TestChaos57_WarmIsBoundedAndDropsWhenSaturated(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_WarmSkipsAHostAlreadyBeingResolved pins the second half of the
// single-flight: a warm for a host whose resolution is already in flight must
// not consume a slot to do nothing.
func TestChaos57_WarmSkipsAHostAlreadyBeingResolved(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_UnresolvedCountryEvaluationIsCounted pins the security-relevant
...
// only way to see it.
func TestChaos57_UnresolvedCountryEvaluationIsCounted(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_SaturationRecoversOnEvidenceNotTime pins the recovery
...
func TestChaos57_SaturationRecoversOnEvidenceNotTime(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_ControlWarmerActuallyResolves is the control for the gates
...
func TestChaos57_ControlWarmerActuallyResolves(t *testing.T) {
	eng := newGeoTestEngine(t)
...
// TestChaos57_ControlDisabledGeoIPDoesNothing pins the default posture: with
...
func TestChaos57_ControlDisabledGeoIPDoesNothing(t *testing.T) {
	newGeoTestEngine(t)
...
// TestChaos57_MetricsAppearOnlyWhenGeoIPIsLoaded pins both halves of the
...
// precedent).
func TestChaos57_MetricsAppearOnlyWhenGeoIPIsLoaded(t *testing.T) {
	series := []string{
...
// TestChaos57_APanickingLeaderStillPublishes pins the single-flight's most
...
func TestChaos57_APanickingLeaderStillPublishes(t *testing.T) {
